...
echo "Testing jpeg..."
python3 ci-extra/check.py jpeg_fix.json jpeg_base.json 3.5 || ((fail = 1))
echo "Testing logger..."
python3 ci-extra/check.py logger_fix.json logger_base.json 20 || ((fail = 1))
echo "Testing pi..."
python3 ci-extra/check.py pi_fix.json pi_base.json 20 || ((fail = 1))
echo "Testing sort..."
